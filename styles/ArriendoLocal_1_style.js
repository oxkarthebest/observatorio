...
var style_ARRIENDOLOCAL_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_ARRIENDOLOCAL_1(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_ARRIENDOLOCAL_1rule0_eval_expression(context)) {
        ...
        var style = rules_ARRIENDOLOCAL_1(feature, value);
        ;
