...
var style_ARRIENDOBODEGA_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_ARRIENDOBODEGA_4(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_ARRIENDOBODEGA_4rule0_eval_expression(context)) {
        ...
        var style = rules_ARRIENDOBODEGA_4(feature, value);
        ;
