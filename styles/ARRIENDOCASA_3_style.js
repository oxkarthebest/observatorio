...
var style_ARRIENDOCASA_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_ARRIENDOCASA_3(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_ARRIENDOCASA_3rule0_eval_expression(context)) {
        ...
        var style = rules_ARRIENDOCASA_3(feature, value);
        ;
